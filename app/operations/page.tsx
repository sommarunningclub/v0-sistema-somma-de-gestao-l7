  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-2xl font-bold text-white tracking-wider">ASSINANTES</h1>
          <p className="text-sm text-neutral-400">Planejamento de missão e supervisão de execução</p>
        </div>
        <div className="flex gap-2">
          <Button className="bg-orange-500 hover:bg-orange-600 text-white">Nova Operação</Button>
          <Button className="bg-orange-500 hover:bg-orange-600 text-white">Briefing de Missão</Button>
        </div>
      </div>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-2 text-xs text-neutral-400">
                    ...
                    <span>{operation.agents} membros atribuídos</span>
                  </div>
                  <div className="flex items-center gap-2 text-xs text-neutral-400">
                    <Clock className="w-3 h-3" />
                    <span>Conclusão est.: {operation.estimatedCompletion}</span>
                  </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <div className="flex justify-between">
                      <span className="text-neutral-400">Membros:</span>
                    ...
                    <div className="flex justify-between">
                      <span className="text-neutral-400">Conclusão Est.:</span>
