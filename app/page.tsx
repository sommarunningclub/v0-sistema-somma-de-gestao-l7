...
export default function TacticalDashboard() {
  ...
  // Fecha submenu de pagamentos quando sidebar é colapsado
  useEffect(() => {
    if (sidebarCollapsed) {
      ...
      <div className="flex h-screen w-screen overflow-hidden bg-black">
        ...
        <aside
          className={`${
            ...
            sidebarCollapsed ? "md:w-16 lg:w-16" : "md:w-64 lg:w-72"
        ...
        >
          <div className={`${sidebarCollapsed ? "p-2" : "p-3 sm:p-4 lg:p-5"} flex-1 flex flex-col min-h-screen md:min-h-auto`}>
            {/* Header */}
            <div className="flex items-center justify-between mb-6 sm:mb-8">
              ...
              <button
                ...
                className="hidden md:block p-1 text-neutral-400 hover:text-orange-500 transition-colors"
            ...
            <nav className="space-y-1 flex-1">
              {[
                ...
                return (
                  <button
                    ...
                    disabled={!hasAccess}
                    className={`w-full flex items-center ${sidebarCollapsed ? "justify-center px-2 py-3" : "gap-2 sm:gap-3 px-3 py-2.5 sm:px-4 sm:py-3"} rounded-lg transition-all active:scale-95 md:active:scale-100 ${
                      !hasAccess
              ...
              {permissions.admin && (
                ...
                >
                  ...
                  {!sidebarCollapsed && <span className="text-sm font-medium truncate">ADMIN</span>}
                </button>
              )}
            </nav>
        ...
        <main className="flex-1 flex flex-col overflow-hidden w-full">
          ...
          <header className="h-14 md:h-16 bg-neutral-800 border-b border-neutral-700 flex items-center justify-between px-3 md:px-6 gap-3">
            <div className="flex items-center gap-2">
              ...
              <button
                onClick={() => setSidebarCollapsed(!sidebarCollapsed)}
                className="hidden md:block p-2 text-neutral-400 hover:text-orange-500 hover:bg-neutral-700 rounded-lg transition-colors flex-shrink-0"
                aria-label={sidebarCollapsed ? "Expandir sidebar" : "Recolher sidebar"}
                title={sidebarCollapsed ? "Expandir sidebar" : "Recolher sidebar"}
              >
                <ChevronRight className={`w-5 h-5 transition-transform duration-300 ${sidebarCollapsed ? "rotate-180" : ""}`} />
            ...
            <div className="flex items-center gap-2 min-w-0 flex-1 justify-center md:justify-start">
              <div className="text-xs md:text-sm text-neutral-400 truncate">
                <span className="hidden sm:inline">SOMMA / </span>
